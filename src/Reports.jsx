    ...
    <div className="h-screen flex flex-col relative">
      ...
      <div className="flex flex-grow mt-16">
        ...
        <div className="flex flex-col flex-1 p-6 space-y-6">
          <h2 className="text-3xl font-bold mb-6">Accident Reports & Statistics</h2>

          {/* Bar chart for accidents on specific roads */}
          <div className="bg-white p-4 shadow rounded">
            <h3 className="text-xl font-semibold mb-4">Accidents by Road</h3>
            <Bar data={accidentData} options={{ responsive: true }} />
          </div>

          {/* Pie chart for accident types */}
          <div className="bg-white p-4 shadow rounded">
            <h3 className="text-xl font-semibold mb-4">Accident Type Distribution</h3>
            <Pie data={accidentTypeData} />
          </div>

          {/* Line chart for accidents over the week */}
          <div className="bg-white p-4 shadow rounded">
            <h3 className="text-xl font-semibold mb-4">Accidents Over Time (Weekly)</h3>
            <Line data={accidentTimeData} options={{ responsive: true }} />
          </div>
          ...
          <div className="bg-white p-4 rounded shadow text-black mt-4">
            ...
            <ul className="list-disc list-inside">
              <li>Road E has the highest number of accidents with 200 recorded incidents.</li>
              <li>Most accidents involve cars, accounting for 60% of total accidents.</li>
              <li>Accidents tend to spike on weekends, with Sunday having the highest count.</li>
            </ul>
          </div>
        </div>
      </div>
